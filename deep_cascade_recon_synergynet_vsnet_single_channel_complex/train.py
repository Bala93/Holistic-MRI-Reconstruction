...
def create_datasets(args):
    ...
    train_data = SliceData(args.train_path,'4x','calgary')
    dev_data   = SliceData(args.validation_path,'4x','calgary')
...
def train_epoch(args, epoch, model,data_loader, optimizer, writer):
    ...
    for iter, data in enumerate(tqdm(data_loader)):
        ...
        #print (img_gt.shape,img_und.shape,img_und_kspace.shape,rawdata_und.shape,masks.shape,sensitivity.shape)
