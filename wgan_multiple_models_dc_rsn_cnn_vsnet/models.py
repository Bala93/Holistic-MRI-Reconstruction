...
class Discriminator(nn.Module):
    def __init__(self,args):
        ...
        #fc1_inp = {'cardiac':12544, 'kirby':50176,'knee-mc-coronal-pd':50176}
        self.conv1 = nn.Conv2d(2,32,(9,9), 1)
        ...
        self.fc1 = nn.Linear(7168,512) # cardiac
    ...
    def forward(self,x):
        ...
        x = F.avg_pool2d(F.leaky_relu(self.conv4(x), 0.2),(2,2))#conv->relu->pool
        x = F.avg_pool2d(F.leaky_relu(self.conv5(x), 0.2),(2,2))#conv->relu->pool
