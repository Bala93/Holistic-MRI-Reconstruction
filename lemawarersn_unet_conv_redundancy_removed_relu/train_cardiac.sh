MODEL='dc-rsn-feat-redundancyremoved_AssistEverywhere-nc3-chattnunetlem-relu'
...
DNCN_MODEL_PATH=${BASE_PATH}'/experiments/'${DATASET_TYPE}'/'${MASK_TYPE}'/acc_'${ACC_FACTOR}'/ablative-dA-fastMRIUNet-wang_etal-three-channelsnew/'
