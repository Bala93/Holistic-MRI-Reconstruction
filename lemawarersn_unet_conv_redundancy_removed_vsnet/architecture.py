...
from models import ReconSynergyNetAblativeFeature
...
class cnn_layer(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv = ReconSynergyNetAblativeFeature()
