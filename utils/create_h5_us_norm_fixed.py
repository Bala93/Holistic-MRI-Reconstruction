...
mask_type = 'gaussian'
src_path = '/data/balamurali/datasets/kirby90/cartesian/validation/acc_4x/*.h5' # take the volfs from cartesian data and use it to produce gaussian us data for kirby_small
dst_dir  = '/data/balamurali/datasets/{}/{}/validation'.format(dataset_type,mask_type)
mask_path = '/data/balamurali/us_masks/{}/{}'.format(dataset_type,mask_type) # Prepare a mask here with image dimension 
